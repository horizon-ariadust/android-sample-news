...
import kotlinx.android.synthetic.main.model_article_small.view.*

@EpoxyModelClass(layout = R.layout.model_article_small)
abstract class ArticleSmallModel : EpoxyModelWithHolder<ArticleSmallModel.ViewHolder>() {
